...
(function() {
    ...
    function createObstacle() {
        const geometry = new THREE.BoxGeometry(0.9, 0.5, 1.0);
        const material = new THREE.MeshPhongMaterial({ color: 0xaa3333 });
        const obstacle = new THREE.Mesh(geometry, material);
        const randomX = (Math.random() - 0.5) * 14;
        obstacle.position.set(randomX, 0.3, -90);
    ...
    function createPowerup() {
        ...
        const material = new THREE.MeshPhongMaterial({ color: 0xffdd44, emissive: 0xffaa00 });
        const powerup = new THREE.Mesh(geometry, material);
        powerup.position.set((Math.random() - 0.5) * 14, 0.3, -80);
    ...
    function fireBullet() {
        ...
        bullet.position.copy(gameShip ? gameShip.position : gamePlane.position);
